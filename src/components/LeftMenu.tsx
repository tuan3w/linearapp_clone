...
export default function ({ showMenu, onCloseMenu }: Props) {
                ...
                <div className='flex flex-col flex-grow-0 flex-shrink-0 px-5 py-3'>
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center p-2 pr-3 rounded cursor-pointer hover:bg-gray-100">
                            <div className='flex text-sm items-center justify-center rounded-sm w-4.5 h-4.5 text-white bg-yellow-500 mr-2.5'>G</div>
